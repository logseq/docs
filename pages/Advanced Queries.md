	...
	- ### Query Inputs
	  These are special values for a query's `:inputs` key above:
		- Page and block inputs
			- `:current-page` - Name of current page. See [example below](((63b70dc8-58a5-4a43-ae19-28143edb7752)))
			- `:current-block` - `:db/id` of current block. See [example below](((63bc5e11-24f1-45fd-945d-4a272e5ecf0d)))
			- `:parent-block` - `:db/id` of parent block
		- Inputs for querying journal page blocks and rules like `between`
			- `:today` - Today's date. See [example below](((63b70dc8-1d59-4348-9737-e62b17fdabca)))
