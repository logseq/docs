...
#+PUBLISHED: true
** [[Sep 5th, 2020]] 
*Version 0.0.2.4-1 (minor change)*
*** [[Fixed Issues]]
**** 1. Doesn't show the dot when there's only a ~title~ attribute
**** 2. Page attributes block has a different background color
**** 3. Both ~All files~ and ~All pages~ use wide layout now
** [[Sep 5th, 2020]] 
*Version 0.0.2.4*
*** [[Fixed Issues]]
**** 1. Fixed page autocomplete might not work under certain circumstances (by haoji)
**** 2. Better hashtag autocomplete handling (by haoji)
**** 3. Fixed Git force push not working
**** 4. Hide the front matter when there's only a ~title~ attribute
**** 5. Fixed loading files issue
**** 6. Fixed wrong save path for new pages, all new pages will be saved to the directory "/pages" now
**** 7. Fixed keep loading when sign out
** [[Sep 2nd, 2020]]
*Version 0.0.2.3 *
*** [[Fixed issues]]
**** 1. Fixed several loading issues, not all of them!!
...
*** [[Notices]]
**** 1. It seems that sometimes the clone will failed when the network is pretty slow.
** [[Aug 31st, 2020]]
*** [[Features]]
