...
*** Currently, the git bindings we are using only support [[https://www.datree.io/resources/git-push-force][git force push]], it will alter your commits history, so be careful! The other option is save all your local changes and Re-index your current repo.
...
*** Add your favorite date-formatter to ~logseq/config.edn~:
#+BEGIN_SRC clojure
...
*** Can Logseq reference blocks or embed blocks?
** Feel free to ask more questions over on the [[https://discuss.logseq.com/c/faq/6][FAQ Section of the Forum]] or #questions channel on [[https://discord.gg/KpN4eHY][Discord]]!
