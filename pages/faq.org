...
1. Hover the sync status dot in the heading bar, it'll show something like this if you have any changed files:
...
2. Go to all files and click "Download" to download any file.
