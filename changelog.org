...
*Version 0.0.1-19*
*** [[Fixed Issues]]
**** 1. ~Shift-click~ hashtags now adds linked to sidebar (by [[haoji]])
**** 2. Graph dot size increases when there're more linked references
*** [[Features]]
**** 1. Roam Research JSON importer #experiment
How to import the data?
Go to https://logseq.com/import
**** 2. Excalidraw embed support #experiment
How to use it?
1. Type ~/draw~
2. Input a title
3. Save the block (either ~ESC~ or click outside the block)
4. Draw it!
**** 3. ~Ctrl+Alt+t~ to toggle between dark/light theme
**** 4. Nested pages support
